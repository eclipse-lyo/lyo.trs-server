...
import org.eclipse.lyo.oslc4j.trs.server.ChangeHistoriesDI;
...
@Path("/trs")
public class TrackedResourceSetServiceDI {
    private static final Logger log     = LoggerFactory.getLogger(TrackedResourceSetServiceDI
                                                                          .class);
    ...
    @Inject private    ChangeHistoriesDI   changeHistories;

    public TrackedResourceSetServiceDI() {
     ...
     */
    ChangeHistoriesDI getChangeHistories() {
