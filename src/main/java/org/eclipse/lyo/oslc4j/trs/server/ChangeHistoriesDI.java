 ...
 */
@ApplicationScoped
public class ChangeHistoriesDI {

    private final static Logger log = LoggerFactory.getLogger(ChangeHistoriesDI.class);
    ...
    @Inject private HistoryDataContainer historyDataContainer;
...
//    }*/
    ...
    public ChangeHistoriesDI(long UPDATEINTERVAL, String serviceBase) {
        this.serviceBase = serviceBase;
        this.UPDATEINTERVAL = UPDATEINTERVAL;
    }

    public ChangeHistoriesDI() {
    }
     ...
     */
    private HistoryData[] getHistory(HttpServletRequest httpServletRequest, Date dateAfter) {
        return historyDataContainer.getHistoryData(dateAfter);
    }
